...
export const metadata: Metadata = {
  title: "Privacy Policy | TopWeekPrize",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to topweekprize.com</h1>
        <p>
        ...
        <p>
          topweekprize.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@topweekprize.com"> admin@topweekprize.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using topweekprize.com, you agree to the practices outlined in this
