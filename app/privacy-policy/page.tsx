...
export const metadata: Metadata = {
  title: "Privacy Policy | Bonus-Top",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to bonus-top.com</h1>
        <p>
        ...
        <p>
          bonus-top.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@bonus-top.com"> admin@bonus-top.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using bonus-top.com, you agree to the practices outlined in this
