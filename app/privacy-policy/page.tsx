...
export const metadata: Metadata = {
  title: "Privacy Policy | CasinoChecker",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to casinochecker.pro</h1>
        <p>
        ...
        <p>
          casinochecker.pro is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@casinochecker.pro"> admin@casinochecker.pro</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using casinochecker.pro, you agree to the practices outlined in this
