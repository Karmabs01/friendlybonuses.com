...
export const metadata: Metadata = {
  title: "Privacy Policy | LemonBonus",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to lemonbonus.com</h1>
        <p>
        ...
        <p>
          lemonbonus.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@lemonbonus.com"> admin@lemonbonus.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using lemonbonus.com, you agree to the practices outlined in this
