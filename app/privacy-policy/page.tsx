...
export const metadata: Metadata = {
  title: "Privacy Policy | Best-Bo-Nus",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to best-bo-nus.com</h1>
        <p>
        ...
        <p>
          best-bo-nus.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@best-bo-nus.com"> admin@best-bo-nus.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using best-bo-nus.com, you agree to the practices outlined in this
