...
export const metadata: Metadata = {
  title: "Privacy Policy | BargainsCasino",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to bargains.casino</h1>
        <p>
        ...
        <p>
          bargains.casino is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@bargains.casino"> admin@bargains.casino</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using bargains.casino, you agree to the practices outlined in this
