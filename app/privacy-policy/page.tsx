...
export const metadata: Metadata = {
  title: "Privacy Policy | Gamblers4Gamblers",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to gamblers4gamblers.com</h1>
        <p>
        ...
        <p>
          gamblers4gamblers.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@gamblers4gamblers.com"> admin@gamblers4gamblers.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using gamblers4gamblers.com, you agree to the practices outlined in this
