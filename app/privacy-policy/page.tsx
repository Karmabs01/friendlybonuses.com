...
export const metadata: Metadata = {
  title: "Privacy Policy | EldoradoReviews",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to eldoradoreviews.com</h1>
        <p>
        ...
        <p>
          eldoradoreviews.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@eldoradoreviews.com"> admin@eldoradoreviews.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using eldoradoreviews.com, you agree to the practices outlined in this
