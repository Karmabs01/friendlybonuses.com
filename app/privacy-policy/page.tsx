  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to au-best.com</h1>
        <p>
        ...
        <p>
          au-best.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@au-best.com"> admin@au-best.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using au-best.com, you agree to the practices outlined in this
