  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to bonus-up.com</h1>
        <p>
        ...
        <p>
          bonus-up.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@bonus-up.com"> admin@bonus-up.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using bonus-up.com, you agree to the practices outlined in this
