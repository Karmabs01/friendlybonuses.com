  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to b-onuses.com</h1>
        <p>
        ...
        <p>
          b-onuses.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@b-onuses.com"> admin@b-onuses.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using b-onuses.com, you agree to the practices outlined in this
