  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          At Friendlybonuses, we believe that gambling should always be a form of
        ...
        <p>
          Friendlybonuses only accepts players who are at least 18 years old and
