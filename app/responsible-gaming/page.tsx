  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          At WinToFast, we believe that gambling should always be a form of
        ...
        <p>
          ...
          <a target="_blank" href="mailto:support@wintofast.com.">
            support@wintofast.com.
          </a>
        </p>
        ...
        <p>
          WinToFast only accepts players who are at least 18 years old and
