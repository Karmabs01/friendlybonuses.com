...
export const metadata: Metadata = {
  title: "Terms and Conditions | BargainsCasino",
  description:
    "Welcome to bargains.casino. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to bargains.casino. These Terms & Conditions govern your
        ...
        <p>
          bargains.casino holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on bargains.casino, you consent to
        ...
        <p>
          ...
          every promotional email sent by bargains.casino. It may take up to
        ...
        <p>
          ...
          bargains.casino. Users are prohibited from reproducing,
          distributing, modifying, or creating derivative works without explicit
          permission.
        </p>
        <h2 className="mb-3">Limitation of Liability</h2>
        <p>
          bargains.casino shall not be liable for any direct, indirect,
        ...
        <p>
          bargains.casino reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using bargains.casino, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@bargains.casino">info@bargains.casino</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://bargains.casino/">
            bargains.casino
          </a>{" "}
        </p>
      </div>
