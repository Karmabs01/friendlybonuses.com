...
export const metadata: Metadata = {
  title: "Terms and Conditions | LemonBonus",
  description:
    "Welcome to lemonbonus.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to lemonbonus.com. These Terms & Conditions govern your
        ...
        <p>
          lemonbonus.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on lemonbonus.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by lemonbonus.com. It may take up to
        ...
        <p>
          lemonbonus.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using lemonbonus.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@lemonbonus.com">info@lemonbonus.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://lemonbonus.com/">
            lemonbonus.com
          </a>{" "}
        </p>
      </div>
