...
export const metadata: Metadata = {
  title: "Terms and Conditions | WinToFast",
  description:
    "Welcome to wintofast.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to wintofast.com. These Terms & Conditions govern your
        ...
        <p>
          wintofast.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on wintofast.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by wintofast.com. It may take up to
        ...
        <p>
          wintofast.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using wintofast.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@wintofast.com">info@wintofast.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://wintofast.com/">
            wintofast.com
          </a>{" "}
        </p>
      </div>
