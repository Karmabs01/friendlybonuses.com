...
export const metadata: Metadata = {
  title: "Terms and Conditions | B-Onuses",
  description:
    "Welcome to b-onuses.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to b-onuses.com. These Terms & Conditions govern your
        ...
        <p>
          b-onuses.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on b-onuses.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by b-onuses.com. It may take up to
        ...
        <p>
          b-onuses.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using b-onuses.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@b-onuses.com">info@b-onuses.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://b-onuses.com/">
            b-onuses.com
          </a>{" "}
        </p>
      </div>
