...
export const metadata: Metadata = {
  title: "Terms and Conditions | Bonus-Up",
  description:
    "Welcome to bonus-up.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to bonus-up.com. These Terms & Conditions govern your
        ...
        <p>
          bonus-up.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on bonus-up.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by bonus-up.com. It may take up to
        ...
        <p>
          bonus-up.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using bonus-up.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@bonus-up.com">info@bonus-up.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://bonus-up.com/">
            bonus-up.com
          </a>{" "}
        </p>
      </div>
