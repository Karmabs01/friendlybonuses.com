...
export const metadata: Metadata = {
  title: "Terms and Conditions | Bonus-Top",
  description:
    "Welcome to bonus-top.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to bonus-top.com. These Terms & Conditions govern your
        ...
        <p>
          bonus-top.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on bonus-top.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by bonus-top.com. It may take up to
        ...
        <p>
          bonus-top.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using bonus-top.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@bonus-top.com">info@bonus-top.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://bonus-top.com/">
            bonus-top.com
          </a>{" "}
        </p>
      </div>
