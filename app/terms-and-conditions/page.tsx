...
export const metadata: Metadata = {
  title: "Terms and Conditions | CasinoChecker",
  description:
    "Welcome to casinochecker.pro. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to casinochecker.pro. These Terms & Conditions govern your
        ...
        <p>
          casinochecker.pro holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on casinochecker.pro, you consent to
        ...
        <p>
          ...
          every promotional email sent by casinochecker.pro. It may take up to
        ...
        <p>
          ...
          casinochecker.pro. Users are prohibited from reproducing,
          distributing, modifying, or creating derivative works without explicit
          permission.
        </p>
        <h2 className="mb-3">Limitation of Liability</h2>
        <p>
          casinochecker.pro shall not be liable for any direct, indirect,
        ...
        <p>
          casinochecker.pro reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using casinochecker.pro, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@casinochecker.pro">info@casinochecker.pro</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://casinochecker.pro/">
            casinochecker.pro
          </a>{" "}
        </p>
      </div>
