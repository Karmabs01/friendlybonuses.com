...
export const metadata: Metadata = {
  title: "Terms and Conditions | Best-Bo-Nus",
  description:
    "Welcome to best-bo-nus.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to best-bo-nus.com. These Terms & Conditions govern your
        ...
        <p>
          best-bo-nus.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on best-bo-nus.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by best-bo-nus.com. It may take up to
        ...
        <p>
          ...
          best-bo-nus.com. Users are prohibited from reproducing,
          distributing, modifying, or creating derivative works without explicit
          permission.
        </p>
        <h2 className="mb-3">Limitation of Liability</h2>
        <p>
          best-bo-nus.com shall not be liable for any direct, indirect,
        ...
        <p>
          best-bo-nus.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using best-bo-nus.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@best-bo-nus.com">info@best-bo-nus.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://best-bo-nus.com/">
            best-bo-nus.com
          </a>{" "}
        </p>
      </div>
