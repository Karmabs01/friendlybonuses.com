...
export const metadata: Metadata = {
  title: "Terms and Conditions | Gamblers4Gamblers",
  description:
    "Welcome to gamblers4gamblers.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to gamblers4gamblers.com. These Terms & Conditions govern your
        ...
        <p>
          gamblers4gamblers.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on gamblers4gamblers.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by gamblers4gamblers.com. It may take up to
        ...
        <p>
          ...
          gamblers4gamblers.com. Users are prohibited from reproducing,
          distributing, modifying, or creating derivative works without explicit
          permission.
        </p>
        <h2 className="mb-3">Limitation of Liability</h2>
        <p>
          gamblers4gamblers.com shall not be liable for any direct, indirect,
        ...
        <p>
          gamblers4gamblers.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using gamblers4gamblers.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@gamblers4gamblers.com">info@gamblers4gamblers.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://gamblers4gamblers.com/">
            gamblers4gamblers.com
          </a>{" "}
        </p>
      </div>
    </div>
