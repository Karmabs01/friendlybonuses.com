...
export const metadata: Metadata = {
  title: "Terms and Conditions | Au-Best",
  description:
    "Welcome to au-best.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to au-best.com. These Terms & Conditions govern your
        ...
        <p>
          au-best.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on au-best.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by au-best.com. It may take up to
        ...
        <p>
          au-best.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using au-best.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@au-best.com">info@au-best.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://au-best.com/">
            au-best.com
          </a>{" "}
        </p>
      </div>
